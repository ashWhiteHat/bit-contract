...
\usepackage{CJKutf8}
% DEBUG: reduce top margin for layout check and set A3 paper size for PDF output; adjust/remove later.
...
\title{Bit Contracts: VM-less Smart Contracts via UTXO and Computational Law with Minimal Third-Party Trust}
