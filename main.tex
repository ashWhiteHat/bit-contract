...
\newcommand{\Buyer}{\mathsf{A}}
\newcommand{\Seller}{\mathsf{B}}
\newcommand{\Oper}{\mathsf{C}}
\newcommand{\sigA}{\mathrm{sig}(\Buyer)}
\newcommand{\sigB}{\mathrm{sig}(\Seller)}
\newcommand{\sigC}{\mathrm{sig}(\Oper)}
...
\newcommand{\Finalize}{\mathrm{ContractFinalize}}
